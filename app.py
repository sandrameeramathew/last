...
X_train, X_test, y_train, y_test = train_test_split(df[['day','store', 'item']], df['sales'], test_size=0.2, random_state=42)
...
date = st.number_input("Select the day",, min_value=1, max_value=10)
